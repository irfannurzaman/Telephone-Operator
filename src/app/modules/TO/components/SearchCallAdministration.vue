<template>
  <section class="mt-7">
    <div id="input" class="q-pa-md">
      ...
      <SInput v-model="input.fromExtension" label-text="From Extension"/>
      <SInput v-model="input.toExtension" label-text="To Extension"/>
      <SInput v-model="input.dialedNo" label-text="Dialed No"/>
      <q-btn
        block
        color="primary"
        max-height="5"
